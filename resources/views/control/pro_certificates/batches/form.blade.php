...
<label class="pc-field"><span>{{ __('certificate_catalog.batch_rows') }} *</span><textarea name="recipient_rows" required maxlength="100000" rows="12" spellcheck="false" data-pc-tsv aria-describedby="pc-tsv-description">{{ old('recipient_rows',"recipient_name\tpublic_name\tspecialization\n") }}</textarea><small id="pc-tsv-description">{{ __('certificates.public_name_help') }} {{ __('certificate_catalog.specialization_help') }}</small></label></section>
@if($rows !== null)
