...
<figure><div class="pm-brand-asset"><img class="pm-round" src="{{ asset('assets/brand/master-v1/wsaca-authority-seal-v2-outlined.svg') }}" alt="World Supreme Authority for Culinary Arbitration" width="140" height="140" loading="lazy"></div><figcaption>WSA-CA<span>{{ __('master_certificates.authority_role') }}</span></figcaption></figure>
