...
@section('content')
<section class="journal-page-head"><div class="public-container"><span>MCIJ · {{ __('journal.kickers.authors') }}</span><h1>{{ __('journal.author_guidelines') }}</h1><p>{{ __('journal.author_guidelines_intro') }}</p></div></section>
