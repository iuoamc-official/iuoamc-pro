...
<figure><div class="pm-brand-asset"><div class="pm-wsaca-crop"><img src="{{ asset('assets/brand/master-v1/wsaca-original.webp') }}" alt="World Supreme Authority for Culinary Arbitration" width="1188" height="565" loading="lazy"></div></div><figcaption>WSA-CA<span>{{ __('master_certificates.authority_role') }}</span></figcaption></figure>
