...
final class ContentArticle extends Model
{
    protected $fillable = [
        ...
        'image_alt', 'author_biography', 'tags', 'author_name', 'publisher_name', 'cover_image_path', 'status',
        'is_featured', 'reading_minutes', 'views_count', 'revision', 'published_at', 'created_by', 'updated_by',
    ];
    protected function casts(): array
    {
        return ['title' => 'array', 'excerpt' => 'array', 'body' => 'array', 'seo_title' => 'array',
            ...
            'is_featured' => 'boolean', 'published_at' => 'datetime', 'reading_minutes' => 'integer', 'views_count' => 'integer', 'revision' => 'integer'];
    }
