...
final class WicpSigner
{
    /** Signed bytes: this ASCII domain, a NUL, then the raw SHA-256 digest. */
    public const SIGNATURE_DOMAIN = "IUOAMC-WICP-REGISTRY-SIGNATURE-V1\0";
    ...
    public function initialize(): void
    {
        ...
        $lockPath = $parent.'/.wicp-registry.initialize.lock';
        ...
        try {
            ...
            $staging = $parent.'/.wicp-registry.keys.'.bin2hex(random_bytes(16));
    ...
    {
        return storage_path('app/secure/wicp-registry');
    }
