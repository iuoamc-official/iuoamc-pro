...
<label class="pc-field"><span>{{ __('certificates.credential_basis') }} *</span><select name="credential_basis" required><option value="programme_completion" @selected(old('credential_basis',$common['credential_basis']??'programme_completion')==='programme_completion')>{{ __('certificates.credential_bases.programme_completion') }}</option><option value="professional_accreditation" @selected(old('credential_basis',$common['credential_basis']??null)==='professional_accreditation')>{{ __('certificates.credential_bases.professional_accreditation') }}</option></select><small>{{ __('certificates.credential_basis_help') }}</small></label>
<label class="pc-field"><span>{{ __('certificates.accreditation_reference') }}</span><input name="accreditation_reference" maxlength="120" dir="ltr" value="{{ old('accreditation_reference',$common['accreditation_reference']??'') }}"><small>{{ __('certificates.accreditation_reference_help') }}</small></label>
<label class="pc-field"><span>{{ __('certificates.accreditation_date') }}</span><input name="accreditation_date" type="date" dir="ltr" value="{{ old('accreditation_date',$common['accreditation_date']??'') }}"></label>
